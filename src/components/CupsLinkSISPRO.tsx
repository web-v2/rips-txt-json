...
const CupsLinkSISPRO = () => {
  return (
    <div className="flex flex-col items-center justify-center p-6 bg-white rounded-lg shadow-md">      
      <div className="mb-4">
        <Globe className="w-20 h-20 text-green-600" />
      </div>
      <h2 className="text-xl font-semibold text-gray-800 mb-4">CUPS</h2>
      <a
        href="https://web.sispro.gov.co/WebPublico/Consultas/ConsultarDetalleReferenciaBasica.aspx?Code=CUPS"
        target="_blank"        
